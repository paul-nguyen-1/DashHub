    ...
    <main className="page-wrap px-4 pb-16 pt-14">
      <section className="island-shell rise-in relative overflow-hidden rounded-4xl px-6 py-12 sm:px-12 sm:py-16">
        ...
        <div className="flex flex-wrap gap-3">
          <Link
            to="/upload"
            className="rounded-full bg-(--lagoon-deep) px-6 py-2.5 text-sm font-semibold text-white! no-underline dark:bg-(--lagoon) transition hover:-translate-y-0.5 hover:opacity-90"
          >
            Upload a CSV →
          </Link>
          <Link
